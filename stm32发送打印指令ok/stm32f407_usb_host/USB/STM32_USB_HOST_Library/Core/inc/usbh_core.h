...
typedef enum {
  ...
  ENUM_DEV_CONFIGURED,
	ENUM_DEV_AGAIN, 		//mydebug_12.19
	ENUM_GET_DEV_AFTERSET,	//mydebug_12.19
	ENUM_GET_CONFIG,					//mydebug_12.19
	ENUM_DEV_AGAIN20					//mydebug_12.19
} ENUM_State;  
